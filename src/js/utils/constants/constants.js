...
let _antialias = true,
  ...
  _countMatched=true,
  _fontSize=10;
const _LEGEND_OPTIONS = `&legend_options=countMatched:${_countMatched};fontAntiAliasing:${_antialias};fontSize:${_fontSize};dpi:${_dpi};fontName:${_font};hideEmptyRules:${_hideEmpty};labelMargin:${_labelMargin};`;
